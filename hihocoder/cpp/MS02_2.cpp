...
////}
//
//Rule getRule(vector<int> addr , bool allow){
//    
//    long long tmp = (long long)addr[0] * 256*256*256 + addr[1] * 256*256 + addr[2] * 256 + addr[3];
//    
//    //int tmp = addr[0] * pow(10 , 9) + addr[1] * pow(10 , 6) + addr[2] * pow(10 , 3) + addr[3];
//    
//    Rule r;
//    
//    r.allow = allow;
//    
//    r.head = tmp/pow(2 , (32-addr[4]));
//    
//    r.mask = addr[4];
//    
//    cout << r.head << endl;
...
//                
//                //allow(addr);
//                Rule tmp_rule = getRule(addr , true);
...
//                
//                //deny(addr);
//                Rule tmp_rule = getRule(addr , false);
//                rules.push_back(tmp_rule);
//            }
//            
//            
